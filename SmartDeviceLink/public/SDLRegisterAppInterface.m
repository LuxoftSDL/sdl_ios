...
- (instancetype)initWithAppName:(NSString *)appName appId:(NSString *)appId languageDesired:(SDLLanguage)languageDesired {
    ...
    NSString *maxVersion = [SDLGlobals sharedGlobals].SDLMaxProxyRPCVersion;
    UInt8 majorVersion = (UInt8)[maxVersion substringWithRange:NSMakeRange(0, 1)].intValue;
    UInt8 minorVersion = (UInt8)[maxVersion substringWithRange:NSMakeRange(2, 1)].intValue;
    UInt8 patchVersion = (UInt8)[maxVersion substringWithRange:NSMakeRange(4, 1)].intValue;
